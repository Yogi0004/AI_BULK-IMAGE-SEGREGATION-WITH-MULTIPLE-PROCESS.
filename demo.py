...
<div style='text-align: center; padding: 2rem; background: linear-gradient(135deg, #8b5cf6 0%, #7c3aed 100%); border-radius: 15px; margin-top: 3rem;'>
    ...
    <p style='margin: 1rem 0 0 0; color: #c4b5fd; font-size: 0.9rem;'>Version 2.4 Professional - Zero Limits + Persistent Statistics + Upload History + AI Text Removal + Auto Watermark | Powered by AI | Developed by Middi Yogananda Reddy</p>
